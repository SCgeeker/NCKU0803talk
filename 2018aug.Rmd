...
![](ScreenTimeEvent-Chambers-2018-priamid.jpg){width=70%}</br>
<small>(Chambers, 2018 London)</small>  

<small>Return [How to select my preregistration](#4/8)</small> </br>
<small>Return [RR: Take Home Message](#/take-home-message)</small>
...
- [COS RR service](https://cos.io/rr/)
- [Latest summary table](https://docs.google.com/spreadsheets/d/1D4_k-8C_UENTRtbPzXfhjEyu3BfLxdOsn9j-otrO870/edit#gid=0): Check list of 21 features; Pre-study peer review (stage 1 peer review) and Provisional pre-study acceptance (in-principle acceptance) are the minimal criteria. 
- [Turn your target journal RR](https://osf.io/tghnz/): Templete letter to editor(s).
...
![](https://pbs.twimg.com/media/DjV2UuMUwAAc0sA.jpg){width=60%}  </br>
<small>Return [Evidence Pyramid](#2/15)</small>
...
![](elmo-apple.jpg){ width=50% }  

- [This paper](https://www.sciencedirect.com/science/article/pii/S0091743512003222) had been retracted because they collected the data from **kindergartens**, not the elementary schools they claimed in their paper.  
...
<div id="right">
- <small>[SPRITE](https://peerj.com/preprints/26968) is designed to evaluate the strange roudings of scaling data, more than 100 samples.</small>  
![](SPRITE_case.png)  
<small>Wansink, Just, Payne, & Klinger (2012, retracted) </small></br>
![](SPRITE_data.png)   
<small>Heathers, Anaya, van der Zee, Brown (2018). Listen more on [soundcloud](https://soundcloud.com/reproducibilitea/specialitea-1-tim-van-der-zee).</small>
...
# 心理科學研究協作網路![](https://s33.postimg.cc/l0t3luze7/Study_Swap.png){width=30%}![](https://psysciacc.files.wordpress.com/2017/10/cropped-cropped-psa.png){width=20%}
...
# 感謝我的兩位引路人{data-background="http://www.educationandlearning.nl/uploads/cfeal/inline-images/20160121_Centre%20for%20Education%20and%20Learning_032.jpg"}
